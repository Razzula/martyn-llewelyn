...
function App() {
  ...
  const accounts: Account[] = [
    ...
    { name: 'Natwest Digital Regular Saver', type: 'regular saver', initialDeposit: 0, annualInterestRate: 6, compoundRate: 1, compoundOffset: 0, state: 'owned' },
    { name: 'Test', type: 'regular saver', initialDeposit: 0, annualInterestRate: 6, compoundRate: 1, compoundOffset: 0 },
  ];
